...
\begin{figure}
\mbox{
        \subfigure[Profiled graph]{
            \includegraphics[width=.40\columnwidth]{figures/profileG}
            \label{fig:PG}
        }
        \hspace{1ex}
        \subfigure[Bipartite graph]{
            \includegraphics[width=.45\columnwidth]{figures/bipartiteG}
            \label{fig:BG}
        }
}
\caption{Construction of the bipartite graph}\label{fig:construction}
\end{figure} 
