 ...
 */
public class KCore {
	private int graph[][] = null;//Dec 5, 2016 CYK: adjacency list to store the graph 
	private int n = -1;//Dec 5, 2016 CYK: size of the graph but minus 1 to index the array (size-1)
