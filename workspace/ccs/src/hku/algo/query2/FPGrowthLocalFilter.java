...
//		System.out.println("FP finished!");
	...
	//**********************  Dec 13, 2016 CYK: overload the mine function
	//mine all the candidate patterns using neighbor infomation
	public List<List<String[]>> mine(Set<String> candKwSet){
		List<List<String[]>> candList = new ArrayList<List<String[]>>();
		candList.add(null);//it takes space for length-0 keyword combination
		
		//step 1: find queryId's keyword set
		Set<String> kwSet = mineWord(queryId, candKwSet);//mine keywords
...
//					System.out.println();
			...
			String[] str=new String[candKwSet.size()];
			List<String[]> listTemp=new ArrayList<String[]>();
			int cc=0;
			for(String stemp:candKwSet){
				str[cc]=stemp;
				cc++;
			}
			listTemp.add(str);
			candList.add(listTemp);
		}catch(Exception e){
			e.printStackTrace();
		}
//		System.out.println("FP finished!");
