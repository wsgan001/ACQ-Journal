...
//		eg.readData(youtube, yout, yNode, "2007-04-14");
		DataReader d1=new DataReader(Config.DflickrGraph,Config.DflickrNode);
		int[][] a1=d1.readGraph();
		String[][] b1=d1.readNode();
		AdvancedIndex advancedIndex=new AdvancedIndex(a1, b1);
		advancedIndex.build();
		DataReader d2=new DataReader(Config.youtubeGraph,Config.youtubeNode);
		int[][] a2=d2.readGraph();
		String[][] b2=d2.readNode();
		AdvancedIndex advancedI1=new AdvancedIndex(a2, b2);
		advancedI1.build();
