...
public class MeshNode {
	...
	public String toString(){
		...
		if(depth<=ConfigPubmed.maxDepth){
//			output.append(name+"	depth: "+depth+"	"+newCode+"	"+DFSNo);
			output.append(name+"\t"+DFSNo);
			output.append("\n");
			for(MeshNode child:childrenList) output.append(child.toString());
		}	
